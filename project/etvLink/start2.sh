...
APP_NAME=etvLink-0.0.1-SNAPSHOT
...
#JVM参数
JVM_OPTS="-Dname=$APP_NAME -Dfile.encoding=utf-8 -Duser.timezone=Asia/Shanghai -Xms512M -Xmx512M -XX:+HeapDumpOnOutOfMemoryError -Xloggc:$GC_LOG_PATH -XX:+PrintGCDetails -XX:NewRatio=1 -XX:SurvivorRatio=30 -XX:+UseParallelGC -XX:+UseParallelOldGC -Dcom.sun.management.jmxremote.rmi.port=8898 -XX:NativeMemoryTracking=detail"


JAR_FILE=/home/service/project/etvLink/$APP_NAME.jar
pid=0
start(){
  checkpid
  if [ ! -n "$pid" ]; then
